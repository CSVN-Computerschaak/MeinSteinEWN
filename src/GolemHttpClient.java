...
public class GolemHttpClient {

    final String inetServer = "www.littlegolem.net";
    ...
    public String logon(String user, String passwd) {
        ...
        try {
            hitSock(log0, null);
            hitSock(log1, null);
            hitSock(log2, "login=" + user + "&password=" + passwd);
            hitSock(log3, null);
        } catch (Exception e) {
    ...
    static String log1 =
        "GET /jsp/login/index.jsp HTTP/1.1\r\n" +
        "Host: www.littlegolem.net\r\n" +
        "Referer: http://www.littlegolem.net/jsp/\r\n" +
        "User-Agent: Mozilla/5.0\r\n" +
        "Accept: text/html;q=0.9,text/plain;q=0.8,image/png,*/" + "*;q=0.5\r\n" +
        "Accept-Language: en-gb;q=0.8,en;q=0.5\r\n" +
        "Connection: Keep-Alive\r\n";
    static String log2 =
        "POST /jsp/login/index.jsp HTTP/1.1\r\n" +
        "Host: www.littlegolem.net\r\n" +
        "Referer: http://www.littlegolem.net/jsp/login/index.jsp\r\n" +
        "User-Agent: Mozilla/5.0\r\n" +
        "Accept: text/html;q=0.9,text/plain;q=0.8,image/png,*/" + "*;q=0.5\r\n" +
        "Accept-Language: en-gb;q=0.8,en;q=0.5\r\n" +
        "Connection: Keep-Alive\r\n";
    static String log3 =
        "GET /jsp/game/index.jsp HTTP/1.1\r\n" +
        "Host: www.littlegolem.net\r\n" +
        "Referer: http://www.littlegolem.net/jsp/login/index.jsp\r\n" +
        "User-Agent: Mozilla/5.0\r\n" +
        "Accept: text/html;q=0.9,text/plain;q=0.8,image/png,*/" + "*;q=0.5\r\n" +
